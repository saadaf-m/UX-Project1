...
# Phase 1: Brainstorm
In conducting user research for this project, I followed a structured, iterative approach to uncover genuine user needs. I started with preliminary work to set clear research goals, identify my target audience, and develop relevant interview questions. Initially, I assumed that small business owners simply needed a streamlined tool to handle invoicing. To validate and expand on this assumption, I conducted interviews with real business owners, gaining deeper insights into their unique pain points, like the challenges of financial jargon, fragmented workflows, and limited mobile accessibility. <br>

Through these conversations, I discovered new insights that reshaped my initial approach. For example, while I expected complexity to be an issue, I hadn’t anticipated just how critical mobile access was for users frequently on the go or how much certain jargon created a barrier for non-experts. I synthesized these findings into detailed user personas representing different levels of financial expertise and needs, which became guiding pillars for my design decisions. <br>

Each pain point I identified was directly tied to actionable design features. For instance, the common challenge with financial jargon led me to incorporate accessible tooltips and a simplified glossary for easy understanding. Similarly, feedback on mobile accessibility shaped my prioritization of a responsive, thumb-friendly mobile layout and minimalistic navigation. Most users expressed a need for a more intuitive overview of unpaid invoices and payment statuses, which directly informed the layout of the dashboard. <br>

Moving forward, I plan to conduct usability testing on early prototypes with these same users to further refine and validate the design. I’m committed to an evidence-based approach, ensuring that every design decision aligns with real user needs. This process not only strengthens the design but also ensures that it truly empowers small business owners in managing their finances efficiently and confidently. <br><br>
