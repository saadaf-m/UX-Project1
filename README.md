...
# Phase 1: Brainstorm
In conducting user research and competitor analysis for this project, I followed a structured, iterative approach to uncover the genuine needs of small business owners and identify existing gaps in the market. I began with preliminary work to set clear research goals, define my target audience, and create relevant interview questions. Initially, I assumed that small business owners simply needed a streamlined tool to handle invoicing. However, my interviews with real business owners provided deeper insights into pain points like financial jargon, fragmented workflows, and mobile accessibility limitations, revealing specific challenges that hadn’t been fully addressed by competitors.

These conversations directly shaped the creation of user personas, each representing different levels of financial expertise, unique workflow needs, and varying familiarity with financial terminology. For instance, one persona emerged as a mobile-first freelancer who required an intuitive layout and minimized jargon, while another represented a business manager needing efficient, desktop-focused workflows for tracking payments. These personas became essential pillars guiding my design direction, ensuring it catered to the diversity within my target audience.

Through competitor analysis, I observed that while other tools offered modular dashboards and color-coded status indicators, they often lacked in-context support for beginners, relied heavily on financial terminology, and had inconsistent mobile functionality. These findings, combined with user insights, shaped my approach by emphasizing simplicity, accessibility, and consistency across devices. For example, the challenge of financial jargon highlighted the need for accessible tooltips and a simplified glossary, while feedback on mobile usage directly influenced my focus on a thumb-friendly layout and intuitive navigation for on-the-go accessibility. Many users also expressed frustration with fragmented workflows for tracking unpaid invoices and payment statuses, which guided me toward creating a cohesive dashboard that prioritized key metrics and reduced task complexity.

Moving forward, I plan to test these features through usability sessions with the same users to refine and validate my design choices. This combined approach of user research and competitor analysis ensures an evidence-based design that not only addresses real-world needs but also differentiates the product by closing gaps left by existing tools. By building from well-defined personas and real insights, my goal is to empower small business owners to manage their finances with confidence, ease, and efficiency across both web and mobile platforms.<br><br>
...
## Workflow to Prepare for User Interviews
...
### Nov. 4
Developed Problem Statements for each persona

### Nov. 6
Today, I developed User Journey Maps for each Persona. What's especially important is that each journey map breaks down the tasks of a goal. A goal for example describes the user flow of one of the tasks being executed by a user. Creating user journey maps really helped me visualize and break down tasks of one of the more important functionalities of the app. This piece of work will go a long way when I'm developing the UI and user flow in Figma. Also, this piece of work gives me a peace of mind as well; just having a user flow visually documented so I can occupy my mind thinking about other things towards the development of the app. Finally, it will go a long way when presented to stakeholders. I think having discovered pain points and laying out a blueprint will give them an easier time digesting a lot of the information I am giving them.

# Miscellaneous Notes / Archive
### Journal Entry/Reflection that was originally in the Brainstorm Section
